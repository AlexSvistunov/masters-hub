...
const RecordingPage = () => {
	...
	const [getRecordingData, isLoading, error, myRecording, setMyRecording] =
		useFetch(() => getRecording(currentToken))
	...
	return (
		<div>
			<Header />
			<Hero />
			<div className='mx-auto min-h-screen' ref={ref}>
				<Tabs />
						...
						<div className='flex flex-col gap-4'>
							{myRecording.map(recording => (
								<Recording
									...
									key={recording.id}
									deleteRecording={() =>
										deleteRecording(recording.id, currentToken, setMyRecording)
									}
								/>
							))}

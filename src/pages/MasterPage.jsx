      ...
      <section className="py-40">
        <div className="container mx-auto">
          ...
          <div className="bg-base-200 p-5 rounded-2xl mb-5">
            ...
            <p>Мастер и преподаватель по ламинированию ресниц и бровей</p>
          </div>
            ...
            <div className="flex">
              ...
              <div className="user-reviews max-w-150">
                <article>
                  ...
                  Прекрасный мастер и собеседник 👍 брови и ресницы привели в порядок, самое главное- как я и хотела, мастер учитывает все пожелания. Бережное отношение к клиентам и приятный сервис)
                  </p>
